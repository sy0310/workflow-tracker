...
CREATE TABLE IF NOT EXISTS "产业分析" (
  ...
  创建者 INTEGER,
  -- 产业分析特有字段
  分析类型 VARCHAR(100), -- 市场分析、竞品分析、趋势分析等
  目标行业 VARCHAR(100),
  分析范围 TEXT,
  数据来源 TEXT,
  分析方法 TEXT,
...
CREATE TABLE IF NOT EXISTS "创意实践" (
  ...
  创建者 INTEGER,
  -- 创意实践特有字段
  创意类型 VARCHAR(100), -- 产品创意、营销创意、服务创意等
  目标用户 VARCHAR(100),
  创意概念 TEXT,
  实施计划 TEXT,
  资源需求 TEXT,
...
CREATE TABLE IF NOT EXISTS "活动策划" (
  ...
  创建者 INTEGER,
  -- 活动策划特有字段
  活动类型 VARCHAR(100), -- 线上活动、线下活动、混合活动
  目标受众 VARCHAR(100),
  活动规模 VARCHAR(50), -- 小型、中型、大型
  预算范围 VARCHAR(100),
  活动地点 TEXT,
...
CREATE TABLE IF NOT EXISTS "资源拓展" (
  ...
  创建者 INTEGER,
  -- 资源拓展特有字段
  资源类型 VARCHAR(100), -- 人力资源、技术资源、资金资源、渠道资源
  目标对象 VARCHAR(100),
  拓展方式 VARCHAR(100), -- 合作、收购、联盟、投资等
  资源价值 TEXT,
  获取难度 VARCHAR(50), -- 低、中、高
  预期收益 TEXT,
  风险评估 TEXT,
  拓展计划 TEXT,
  关键联系人 TEXT,
